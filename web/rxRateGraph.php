  ...
  <head>
    ...
    <?php
        ...
        if(isset($_GET["submit_1min"]))
        {
          $time = 60;
          $numPoints = 100;
          $titleStr = "RX Usage Rate - 1 Min";
        }
        if(isset($_GET["submit_5min"]))
        {
          $time = 5*60;
          $numPoints = 100;
          $titleStr = "RX Usage Rate - 5 Min";
        }
        if(isset($_GET["submit_15min"]))
        {
          $time = 15*60;
          $numPoints = 100;
          $titleStr = "RX Usage Rate - 15 Min";
        }
        if(isset($_GET["submit_1hr"]))
        {
          $time = 3600;
          $numPoints = 100;
          $titleStr = "RX Usage Rate - 1 Hr";
        }
        if(isset($_GET["submit_4hr"]))
        {
          $time = 3600*4;
          $numPoints = 400;
          $titleStr = "RX Usage Rate - 4 Hrs";
        }
        if(isset($_GET["submit_12hr"]))
        {
          $time = 3600*12;
          $numPoints = 500;
          $titleStr = "RX Usage Rate - 12 Hrs";
        }
        ...
        if(isset($_GET["submit_3day"]))
        {
          $time = 3600*24*3;
          $numPoints = 800;
          $titleStr = "RX Usage Rate - 3 Days";
        }
        if(isset($_GET["submit_7day"]))
        {
          $time = 3600*24*7;
          $numPoints = 2000;
          $titleStr = "RX Usage Rate - 7 Days";
        }
        if(isset($_GET["submit_30day"]))
        {
          $time = 3600*24*30;
          $numPoints = 2000;
          $titleStr = "RX Usage Rate - 30 Days";
        }
    ?>
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          [{type: 'datetime', label: 'Time'}, 'RX Usage Rate (Mbps)'],
        ...
        var options = {
          ...
          vAxes: {
            ...
            0: {title: 'RX Usage Rate (Mbps)', textPosition: 'out'}
          },
   ...
   <body>
    ...
    <center>
    <br>
    <form action="rxRateGraph.php" method="get">
