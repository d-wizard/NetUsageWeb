  ...
  <head>
    ...
    <?php
        ...
        if(isset($_GET["submit_1min"]))
        {
          $time = 60;
          $numPoints = 100;
          $titleStr = "TX Usage Sum - 1 Min";
        }
        if(isset($_GET["submit_5min"]))
        {
          $time = 5*60;
          $numPoints = 100;
          $titleStr = "TX Usage Sum - 5 Min";
        }
        if(isset($_GET["submit_15min"]))
        {
          $time = 15*60;
          $numPoints = 100;
          $titleStr = "TX Usage Sum - 15 Min";
        }
        if(isset($_GET["submit_1hr"]))
        {
          $time = 3600;
          $numPoints = 100;
          $titleStr = "TX Usage Sum - 1 Hr";
        }
        if(isset($_GET["submit_4hr"]))
        {
          $time = 3600*4;
          $numPoints = 400;
          $titleStr = "TX Usage Sum - 4 Hrs";
        }
        if(isset($_GET["submit_12hr"]))
        {
          $time = 3600*12;
          $numPoints = 500;
          $titleStr = "TX Usage Sum - 12 Hrs";
        }
        ...
        if(isset($_GET["submit_3day"]))
        {
          $time = 3600*24*3;
          $numPoints = 800;
          $titleStr = "TX Usage Sum - 3 Days";
        }
        if(isset($_GET["submit_7day"]))
        {
          $time = 3600*24*7;
          $numPoints = 2000;
          $titleStr = "TX Usage Sum - 7 Days";
        }
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          [{type: 'datetime', label: 'Time'}, 'TX Usage Sum (GiB)'],
        ...
        var options = {
          ...
          vAxes: {
            ...
            0: {title: 'TX Usage Sum (GiB)', textPosition: 'out'}
          },
